        ...
        return http
                ...
                .authorizeHttpRequests(auth->
                        auth.requestMatchers(HttpMethod.POST,"/login").permitAll()
                                ...
                                .requestMatchers(HttpMethod.GET,"/paciente/receitas_consulta/{id}").permitAll()
                                .requestMatchers(HttpMethod.GET,"/paciente/detalhes_exame/{id}").permitAll()
                                .requestMatchers(HttpMethod.GET,"/paciente/todas_exames/{id}").permitAll()
                                .requestMatchers(HttpMethod.GET,"/medico/detalhes_consulta_medico/{id}").permitAll()
                                .requestMatchers(HttpMethod.GET,"/medico/todas_consultas_medico/{id}").permitAll()
                                .requestMatchers(HttpMethod.GET,"/medico/receitas_consulta_medico/{id}").permitAll()
                                .requestMatchers(HttpMethod.GET,"/medico/detalhes_exame_medico/{id}").permitAll()
                                .requestMatchers(HttpMethod.GET,"/medico/todas_exames_medico/{id}").permitAll()
                                .requestMatchers(HttpMethod.GET,"/receita").permitAll()
                                .requestMatchers(HttpMethod.POST,"/pagamento").permitAll()
                                .requestMatchers(HttpMethod.PUT,"/pagamento").permitAll()
                                .requestMatchers(HttpMethod.DELETE,"/pagamento/{id}").permitAll()
                                ...
                                .requestMatchers(HttpMethod.PUT,"/consulta").hasAnyAuthority("ROLE_PACIENTE","ROLE_ADMIN")
                                .requestMatchers(HttpMethod.PUT,"/receita").hasAnyAuthority("ROLE_PACIENTE","ROLE_ADMIN")
                                .requestMatchers(HttpMethod.PUT,"/medicamento").hasAnyAuthority("ROLE_PACIENTE","ROLE_ADMIN")
